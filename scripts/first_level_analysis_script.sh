...
for idx in `seq -w 1 26` ; do
    ...
    cp /home/omar_saad/Tasks/Flanker_Dataset/Designs/preprocessing_design_run1.fsf .
    cp /home/omar_saad/Tasks/Flanker_Dataset/Designs/preprocessing_design_run2.fsf .
        #copy preprocessing desgin files
    cp /home/omar_saad/Tasks/Flanker_Dataset/Designs/statistics_design_run1.fsf .
    cp /home/omar_saad/Tasks/Flanker_Dataset/Designs/statistics_design_run2.fsf .
